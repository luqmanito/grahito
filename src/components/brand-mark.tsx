...
export async function BrandMark({ compact = false }: { compact?: boolean }) {
  ...
  return (
    <Link href="/" className="group inline-flex items-center gap-3 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink focus-visible:ring-offset-4" aria-label={`Grahito Labs — ${dictionary.notFound.home}`}>
