...
export const metadata: Metadata = { title: "Kebijakan Privasi", description: "Kebijakan privasi umum untuk website dan akun Grahito Labs.", alternates: { canonical: "/privacy" } };
...
export default function PrivacyPage() {
  return <LegalPageLayout title="Kebijakan Privasi" description="Penjelasan tentang data yang diproses saat kamu menggunakan website dan akun Grahito Labs.">
    ...
    <h2>7. Cookie</h2><p>Cookie digunakan untuk mempertahankan sesi autentikasi akun. Website ini tidak menempatkan cookie analytics atau iklan pada versi awal.</p>
